    ...
    <div className="relative z-30">
      ...
      >
        ...
        <MenuItem className="flex gap-2" onClick={logOutHandler}>
          <div
            className="font-semibold w-full flex gap-2 items-center 
  bg-linear-to-r from-blue-500 via-blue-600 to-indigo-700 
  px-4 py-1 text-white rounded-md shadow-md 
