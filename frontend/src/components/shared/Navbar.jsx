    ...
    <div className="h-[70px] text-white z-50 flex items-center sticky top-0 bg-[linear-gradient(to_right,#1e3c72,#2a5298)]">
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        ...
        <ul
          ...
          } transition-all duration-100 sm:h-fit sm:bg-none bg-[linear-gradient(to_right,#1e3c72,#2a5298)] rounded-b-xl shadow-lg z-50 text-white sm:w-fit w-full sm:flex-row flex-col px-4 sm:px-0`}
        >
